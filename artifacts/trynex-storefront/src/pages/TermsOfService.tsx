          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                These Terms of Service govern your use of the TryNex Lifestyle website (trynex.com.bd) and all related services. By placing an order, you confirm that you are at least 18 years old (or have parental consent) and agree to be bound by these terms.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                ...
                <a href="mailto:hello@trynex.com.bd" className="text-orange-600 font-bold hover:underline">hello@trynex.com.bd</a>.
              </p>
            </section>
          </div>
        </div>
