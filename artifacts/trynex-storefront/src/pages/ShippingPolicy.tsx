...
const SHIPPING_ZONES = [
  { zone: "Dhaka City", time: "1-2 business days", cost: "৳60" },
  { zone: "Dhaka Division", time: "2-3 business days", cost: "৳80" },
  { zone: "Chittagong Division", time: "3-5 business days", cost: "৳100" },
  { zone: "Other Divisions", time: "3-7 business days", cost: "৳100" },
];
            ...
            <section>
              ...
              <div className="p-5 rounded-2xl bg-blue-50 border border-blue-100">
                <p className="text-sm text-gray-700 leading-relaxed">
                  Custom orders are produced within <strong>48 hours</strong> of payment confirmation. Ready-made products ship within <strong>24 hours</strong>. Processing does not include weekends or public holidays.
                </p>
              </div>
            </section>
